...
train_generator=datagen.flow_from_dataframe(dataframe=train_df, directory=train_dir, x_col="filename", y_col="obj_name", batch_size=64)
valid_generator=datagen.flow_from_dataframe(dataframe=valid_df, directory=valid_dir, x_col="filename", y_col="obj_name", batch_size=64)
...
with strategy.scope():
    base_model = keras.applications.resnet50.ResNet50(weights= None, pooling ='avg', include_top=False, input_shape= (128,128,3))
